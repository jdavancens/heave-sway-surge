...
from materials.woodwindfingerings.clarinet.alternate_fingering_map \
    import alternate_fingering_map
from materials.woodwindfingerings.clarinet.basic_fingering_map \
...
from surge.illustration.illustrate_fingerings \
