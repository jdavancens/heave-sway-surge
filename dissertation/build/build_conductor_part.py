...
from dissertation.segments.segment_1.make_conductor_part \
...
if __name__ == '__main__':
    with systemtools.Timer() as big_timer:
        ...
        score_ly_path = os.path.join(build_path, 'conductor.ly')
        score_pdf_path = os.path.join(build_path, 'conductor.pdf')
