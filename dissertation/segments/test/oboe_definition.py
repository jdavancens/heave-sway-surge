...
embouchure_music_maker = MusicMaker(
    ...
    rhythm_maker=rhythmmakertools.TupletRhythmMaker(tuplet_ratios=tuplet_ratios_embouchure)
    )
...
lh_fingering_music_maker = MusicMaker(
    ...
    time_signatures=time_signatures,
    divisions=divisions,
    rhythm_maker=rhythmmakertools.TupletRhythmMaker(tuplet_ratios=tuplet_ratios_lh)
    )
rh_fingering_music_maker = MusicMaker(
    ...
    time_signatures=time_signatures,
    divisions=divisions,
    rhythm_maker=rhythmmakertools.TupletRhythmMaker(tuplet_ratios=tuplet_ratios_rh)
    )
