...
class WoodwindFingeringHandler(object):
    ...
    __slots__=( '_lh_music_maker', '_rh_music_maker', '_fingering_maker', )
    ...
    def _annotate_logical_ties(self, lh_voice, rh_voice, current_stage):
        ...
        for vertical_moment in iterate(staff_group).by_vertical_moment():
            ...
            fingering = self._fingering_maker(l, r, current_stage)
        ...
        for i, logical_tie in enumerate(lh_logical_ties):
            if isinstance(logical_tie.head, (Note, Chord)):
                self._annotate_logical_tie(logical_tie, lh_fingerings[i])
            else:
        ...
        for i, logical_tie in enumerate(rh_logical_ties):
            if isinstance(logical_tie.head, (Note, Chord)):
                self._annotate_logical_tie(logical_tie, rh_fingerings[i])
            else:
