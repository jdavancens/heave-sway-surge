...
from abjad.tools.instrumenttools import ClarinetInBFlat
from surge.materials.observer.time_signatures import time_signatures
from surge.materials.observer.clarinet import *
...
fingerings_json_path_rel = '../materials/observer/clarinet/fingerings.json'
