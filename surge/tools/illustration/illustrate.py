...
def illustrate(expr, file_path):
    lilypond_file = abjad.LilyPondFile.new(expr)
    ...
    abjad.setting(context_block).proportional_notation_duration = moment
    abjad.markuptools.override(context_block).beam.breakable = True
