...
class GuitarStaffGroupTemplate:
    ...
    def __call__(self):
        ...
        abjad.setting(
            fretting_staff
        ).instrument_name = abjad.Markup('Fretting')
        abjad.setting(
            fretting_staff
        ).short_instrument_name = abjad.Markup('Fretting')
        ...
        abjad.setting(
            picking_staff
        ).instrument_name = abjad.Markup('Picking')
        abjad.setting(
            picking_staff
        ).short_instrument_name = abjad.Markup('Picking')
