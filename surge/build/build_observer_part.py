...
if __name__ == '__main__':
    ...
    part_ly_path = os.path.join(build_path, "observer_"+part_name_snake_case+'.ly')
    part_pdf_path = os.path.join(build_path, "observer_"+part_name_snake_case+'.pdf')
    part_midi_path = os.path.join(build_path, "observer_"+part_name_snake_case+'.mid')
