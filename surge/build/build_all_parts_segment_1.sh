...
python build_part.py segment_i 'guitar ii' 5 n;
python build_part.py segment_i violin 5 n;
python build_part.py segment_i viola 5 n;
python build_part.py segment_i cello 5 n;
python build_part.py segment_i bass 5 n;
