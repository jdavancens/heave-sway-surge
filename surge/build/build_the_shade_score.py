...
from abjad import *
from surge import *
from surge.segments.the_shade.make_score import make_score
import datetime
import os
import sys
...
if __name__ == '__main__':
    with systemtools.Timer() as big_timer:
        ...
        score_ly_path = os.path.join(build_path, 'the_shade_score.ly')
        score_pdf_path = os.path.join(build_path, 'the_shade_score.pdf')
