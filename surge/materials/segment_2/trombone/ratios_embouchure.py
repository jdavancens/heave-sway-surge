...
ratio_makers_embouchure_stage_3 = (
    ...
    RatioMaker(
        ...
        subdivider=EvenSubdivider(
            ...
            silence_mask=rhythmmakertools.silence_every([1], period=3),
            second_level_subdivider=UnitSubdivider(
                multiplier=2,
                rotation_cycle=[0, 1, 2],
                sustain_mask=rhythmmakertools.sustain_every([2], period=3),
                ),
    ...
    RatioMaker(
        ...
        subdivider=EvenSubdivider(
            n_cycle=[3, 4, 5],
            rotation_cycle=[0, 1, 2],
            silence_mask=rhythmmakertools.silence_every([2], period=3),
            second_level_subdivider=UnitSubdivider(
                multiplier=2,
                rotation_cycle=[0, 1, 2],
                sustain_mask=rhythmmakertools.sustain_every([2], period=3),
    ...
    RatioMaker(
        ...
        subdivider=EvenSubdivider(
            n_cycle=[3, 4],
            rotation_cycle=[0, 1, 2],
            silence_mask=rhythmmakertools.silence_first(),
            second_level_subdivider=UnitSubdivider(),
...
ratio_makers_embouchure_stage_4 = (
    ...
    RatioMaker(
        ...
        subdivider=EvenSubdivider(
            n_cycle=[4, 5, 6],
            rotation_cycle=[0, 1, 2],
            silence_mask=rhythmmakertools.silence_every([4], period=5),
        )
    )
)
