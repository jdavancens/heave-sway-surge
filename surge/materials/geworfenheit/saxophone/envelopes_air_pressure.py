...
envelopes_air_pressure[2].set_interpolater(random_interpolater)
envelopes_air_pressure[3].set_interpolater(random_interpolater)
envelopes_air_pressure[4].set_interpolater(random_interpolater)
envelopes_air_pressure[5].set_interpolater(random_interpolater)
