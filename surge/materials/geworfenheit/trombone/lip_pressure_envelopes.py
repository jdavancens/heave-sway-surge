...
random_interpolater = RandomInterpolater(seed=hash('enobmort'))
...
lip_pressure_envelopes[4].set_interpolater(random_interpolater)
lip_pressure_envelopes[5].set_interpolater(random_interpolater)
