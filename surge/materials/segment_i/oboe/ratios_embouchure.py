...
ratio_makers_embouchure_stage_2 = (
    ...
    RatioMaker(
        ...
        subdivider=UnitSubdivider(
            ...
            sustain_mask=rhythmmakertools.SustainMask(patterns.pattern_3a)
        )
    ),
    # 2-3
    RatioMaker(
...
ratio_makers_embouchure_stage_4 = (
    ...
    RatioMaker(
        ...
        subdivider=UnitSubdivider(
            rotation_cycle=[0, 1, 2],
            sustain_mask=rhythmmakertools.SustainMask(patterns.pattern_7c),
            silence_mask=rhythmmakertools.SilenceMask.silence_every(
                [3],
                period=4
            ),
    ...
    RatioMaker(
        ...
        subdivider=UnitSubdivider(
            rotation_cycle=[0, 1, 2],
            sustain_mask=rhythmmakertools.SustainMask(patterns.pattern_4c),
            silence_mask=rhythmmakertools.SilenceMask.silence_every(
                [3],
                period=4
            ),
    ...
    RatioMaker(
        ...
        subdivider=UnitSubdivider(
            rotation_cycle=[0, 1, 2],
            sustain_mask=rhythmmakertools.SustainMask(patterns.pattern_4a),
            silence_mask=rhythmmakertools.SilenceMask.silence_every(
                [3],
                period=4
            ),
