...
from surge.illustration.illustrate import illustrate
from surge.actions.WoodwindFingeringCombination import WoodwindFingeringCombination
import copy, os
...
def illustrate_fingerings(instrument, fingering_map, file_path, kind='basic'):
    ...
    sounding_staff_name = Instrument(
        instrument_name='Sounding',
        short_instrument_name='Sounding'
        )
    written_staff_name = Instrument(
