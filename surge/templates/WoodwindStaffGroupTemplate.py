...
class WoodwindStaffGroupTemplate():
    ...
    def __call__(self):
        ...
        abjad.setting(
            embouchure_staff
        ).instrument_name = abjad.markuptools.Markup('Emb.')
        abjad.setting(
            embouchure_staff
        ).short_instrument_name = abjad.markuptools.Markup('Emb.')
        ...
        abjad.setting(
            lh_fingering_staff
        ).instrument_name = abjad.markuptools.Markup('L.H.')
        abjad.setting(
            lh_fingering_staff
        ).short_instrument_name = abjad.markuptools.Markup('L.H.')
        ...
        abjad.setting(
            rh_fingering_staff
        ).instrument_name = abjad.markuptools.Markup('R.H.')
        abjad.setting(
            rh_fingering_staff
        ).short_instrument_name = abjad.markuptools.Markup('R.H.')
        ...
        instrument_annotation = indicatortools.Annotation(
        ...
        ).instrument_name = abjad.markuptools.Markup(name)
        abjad.setting(
            instrument_staff_group
        ).instrument_name = abjad.markuptools.Markup(short_name)
